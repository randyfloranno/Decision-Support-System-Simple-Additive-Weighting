create procedure updDetilPenilaian2

as
begin
declare @cek_kode_kriteria bigint, @jenis_kriteria varchar(10), @xkode_kriteria varchar(13), @xkode_tempat varchar(13), @xdp_nilai decimal(18,2), @max_dp_nilai decimal(18,2), @min_dp_nilai decimal(18,2), @dp_normalisasi decimal(18,2), @bobot_kriteria int, @nilai_akhir decimal(18,2), @xdp_normalisasi decimal(18,2)
set @cek_kode_kriteria = (select count(kode_kriteria) from detil_penilaian)
if(@cek_kode_kriteria != 0 or @cek_kode_kriteria != null)
begin
